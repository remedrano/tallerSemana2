(function () {
	...
	app.saveEstacion = function ( estacion ) {
					
		var request = indexedDB.open("estacion" , 1);
									
		request.onupgradeneeded = function(e) {
           
            var db = e.target.result;				
			var store = db.createObjectStore('data', {keyPath:"key",autoIncrement: true});
			var transaction = e.target.transaction;		
					
			//console.log(db , transaction,store);			
			var requestStore = store.add(estacion);

			requestStore.onerror = function(e) {
        ...
        request.onsuccess = function(e) {            
			...
			//console.log("Success!", e.target,store );
			store.add( estacion ); 			
        }
    ...
    document.getElementById('butAddCity').addEventListener('click', function () {
		...
		app.saveEstacion( {key: key, label: label} );
